  ...
  <div>
    ...
    <div className="md-cell md-cell--12">
      ...
      <p>
        ...
        Gründen an unbeteiligte Dritte weitergegeben. Wir behalten uns
        allerdings die bedingte Weitergabe der erhobenen Daten an Dritte vor,
        sofern diese die erhobenen Daten in unserem Auftrag und im Sinne dieser
        Datenschutzerklärung weiterverarbeiten. Die nachfolgende Erklärung gibt
        Ihnen einen Überblick darüber, wie wir diesen Schutz gewährleisten und
        welche Art von Daten zu welchem Zweck erhoben werden. Durch die Nutzung
        dieser Webseite erklären Sie sich mit der vorliegenden
        Datenschutzerklärung einverstanden. Erhebung von Informationen Wir
        erheben und speichern automatisch in unseren Server Log Files
        Informationen, die Ihr Browser an uns übermittelt. Dies sind: -
        Browsertyp/ -version - verwendetes Betriebssystem - Referrer URL (die
        zuvor besuchte Seite) - Hostname des zugreifenden Rechners (IP Adresse)
        - Uhrzeit der Serveranfrage. Eine Zuordnung dieser Daten zu bestimmten
        Personen wird von uns nicht vorgenommen und ist nicht möglich. Eine
        Zusammenführung dieser Daten mit anderen Datenquellen wird nicht
        vorgenommen, die Daten werden zudem nach einer statistischen Auswertung
        gelöscht. Näheres zur statistischen Auswertung unter Punkt 6 dieser
        Erklärung. Weitergabe an Dritte Wir geben Ihre Daten generell nicht an
        unbeteiligte Dritte weiter. Allerdings geben wir die gesammelten
        Informationen (siehe 1) an Unternehmen weiter, die den Betrieb dieser
        Webseite ermöglichen und die Daten im Sinne dieser Erklärung nutzen. Zu
        diesen Unternehmen gehört in erster Linie unser Internetprovider.
        Cookies Diese Internetseite verwendet an mehreren Stellen so genannte
        Cookies. Sie dienen dazu, unser Angebot nutzerfreundlicher, effektiver
        ...
        Ihrem Rechner keinen Schaden an und enthalten keine Viren. Weitere
        Informationen zu Cookies finden sie unter Punkt 6 dieser Erklärung. Sie
