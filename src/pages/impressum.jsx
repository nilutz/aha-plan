...
const Impressum = () => (
  <div className="md-grid">
    ...
    <div className="md-cell md-cell--12">
      ...
      <p>
        a) Beim Besuch der Website Beim Aufrufen unserer Website www.aha-plan.de
        ...
        Rechners, Datum und Uhrzeit des Zugriffs, Name und URL der abgerufenen
        Datei, Website, von der aus der Zugriff erfolgt (Referrer-URL),
        verwendeter Browser und ggf. das Betriebssystem Ihres Rechners sowie der
        Name Ihres Access-Providers. Die genannten Daten werden durch uns zu
        ...
        Nutzung unserer Website, Auswertung der Systemsicherheit und -stabilität
        sowie zu weiteren administrativen Zwecken. Die Rechtsgrundlage für die
        ...
        Zweck, Rückschlüsse auf Ihre Person zu ziehen. Darüber hinaus setzen wir
      ...
      <p>
        ...
        1 S. 1 lit. a DSGVO ausdrückliche Einwilligung dazu erteilt haben, die
        ...
        schutzwürdiges Interesse an der Nichtweitergabe Ihrer Daten haben, für
        den Fall, dass für die Weitergabe nach Art. 6 Abs. 1 S. 1 lit. c DSGVO
        eine gesetzliche Verpflichtung besteht, sowie dies gesetzlich zulässig
        und nach Art. 6 Abs. 1 S. 1 lit. b DSGVO für die Abwicklung von
        Vertragsverhältnissen mit Ihnen erforderlich ist.
      </p>
      <h5>4. Analyse-Tools</h5>
      <p>
      ...
      <p>
        ...
        übertragen und dort gespeichert. Die Informationen werden verwendet, um
        die Nutzung der Website auszuwerten, um Reports über die
        ...
        eine Zuordnung nicht möglich ist (IP-Masking). Sie können die
        ...
        vollumfänglich genutzt werden können. Sie können darüber hinaus die
        ...
        Sie die Erfassung durch Google Analytics zudem verhindern, indem Sie auf
        diesen Link klicken. Es wird ein Opt-out-Cookie gesetzt, das die
      ...
      <p>
        ...
        Betrieb ist durch deren jeweiligen Anbieter zu gewährleisten. Die
        Einbindung dieser Plug-ins durch uns erfolgt im Wege der sogenannten
        Zwei-Klick-Methode um Besucher unserer Webseite bestmöglich zu schützen.
        a) Verwendung von Xing/ Linkedin und Twitter Social Plugins Dieser
        Internetauftritt verwendet auf der gesamten Homepage Social Plugins
        ("Plugins") der folgenden sozialen Netzwerke: xing.com, welches von der
        Xing AG, Gänsemarktstr. 43, 20354 Hamburg betrieben wird ("Xing"). Die
        Plugins sind mit einem Xing Logo gekennzeichnet. linkedin.com, welches
        von der LinkedIn Corporation, 2029 Stierlin Court,Mountain View, CA
        94043 USA betrieben wird ("linkedin"). Die Plugins sind mit einem
        Linkedin Logo gekennzeichnet. twitter.com, welches von der Twitter Inc.,
        795 Folsom St., Suite 600, San Francisco CA 94107, USA betrieben wird
        ("Twitter"). Die Plugins sind mit einem Twitter Logo oder dem Zusatz
        "Twitter Social Plugin" gekennzeichnet. Wenn Sie eine Webseite unseres
        Internetauftritts aufrufen, in welche ein solches Plugin integriert ist,
        baut Ihr Browser eine direkte Verbindung mit den Servern des jeweiligen
        sozialen Netzwerks Xing/ Linkedin/Twitter auf. Der Inhalt des Plugins
        wird von Xing/ Linkedin/Twitter direkt an Ihren Browser übermittelt und
        von diesem in die Webseite eingebunden. Wir haben daher keinen Einfluss
        auf den Umfang der Daten, die Xing/ Linkedin/ Twitter mit Hilfe des
        Plugins erhebt und informieren Sie daher entsprechend unserem
        Kenntnisstand: Durch die Einbindung der Plugins erhält Xing/ Linkedin/
        Twitter die Information, dass Sie die entsprechende Seite unseres
        Internetauftritts aufgerufen haben. Sofern Sie gleichzeitig bei Xing/
        Linkedin/ Twitter eingeloggt sind, kann Xing/ Linkedin/Twitter den
        Besuch Ihrem Xing-/ Linkedin-/Twitter - Konto zuordnen. Wenn Sie mit den
        ...
        Ihrem Browser direkt an Xing/ Linkedin/ Twitter übermittelt und dort
        gespeichert. Falls Sie kein Mitglied von Xing/ Linkedin/ Twitter sind,
        besteht trotzdem die Möglichkeit, dass Xing/ Linkedin/ Twitter Ihre
        IP-Adresse in Erfahrung bringt und speichert. Zweck und Umfang der
        Datenerhebung und die weitere Verarbeitung und Nutzung der Daten durch
        Xing/ Linkedin/ Twitter sowie Ihre diesbezüglichen Rechte und
        Einstellungsmöglichkeiten zum Schutz Ihrer Privatsphäre entnehmen Sie
        bitte den Datenschutzhinweisen des jeweiligen (sozialen) Netzwerks Xing/
        Linkedin/ Twitter in der jeweils gültigen Form. Zu finden unter: Xing:
        http://www.xing.com/privacy, Linkedin:
        http://de.linkedin.com/legal/privacy-policy, Twitter:
        https://twitter.com/privacy Sofern Sie nicht möchten, dass Xing/
        Linkedin/ Twitter über unseren Internetauftritt Daten über Sie sammelt,
        sollten Sie sich vor Ihrem Besuch unseres Internetauftritts bei Xing/
      ...
      <h5>10. Aktualität und Änderung dieser Datenschutzerklärung</h5>
      <p>
    ...
    <div className="md-cell md-cell--12">
      <h4>Open Source</h4>
      <p>
        Diese Website ist open-source, besuche das github{" "}
        <a href="https://github.com/nilutz/aha-plan">repository</a> für mehr
        Informationen.
      </p>
    </div>
  </div>
