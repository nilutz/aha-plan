...
class Greeter extends Component {
  render() {
    return (
      <StyledContainerDiv>
        <Styledh1>
          AHa-Plan nimmt sich zum Ziel Kundenwünsche und Technikwissen zu
          vereinen, um die bestmögliche Realisierung ihres AV, Medien oder
          Digital Signage Projektes zu verwirklichen.
        </Styledh1>
        <Separator />
        ...
        <div className="md-grid">
          <div className="md-cell md-cell--4" style={{ textAlign: "center" }}>
            ...
            <Styledh4>
              Medientechnikplanung für Licht, Audio und Video für
          ...
          <div className="md-cell md-cell--4" style={{ textAlign: "center" }}>
            ...
            <Styledh4>
              Entwicklung, Konstruktion und Planung von Displays für
