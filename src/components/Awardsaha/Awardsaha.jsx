    ...
    return(
      <div>
        ...
        <div className='md-grid'>
          ...
          <Styledli>360 °Projektion sowie 3D Projektion, Rückprojektionen</Styledli>
          <Styledli>U-Bahnhöfe für Stroer+, Großbildtower-Infoscreen für ICE- Bahnhöfe. Centralscreens mit steglos Plasma+ LCD</Styledli>
          <Styledli>Lens shift Technologie und Scaler </Styledli>
          <Styledli>Displays für jede KStyledlimazone</Styledli>
          <Styledli>Sunlight Display für Innen und Außen Entwicklung von Solar Display(TV ohne Strom)</Styledli>
          ...
          <Styledli>Roll Out: Sunlight Displays: Telekom, Dt.Bank, T-Mobile </Styledli>
          <Styledli>9er Sunlight Outdoor Monitor für Standorte in CH-Skigebiete</Styledli>
          ...
          <Styledli>Projekte in Europa, Indien, Singapore, USA, Südamerika, Asien...</Styledli>
          </ul>
          </div>
        </div>
      </div>
